  ...
  render () {
    ...
    return (
      <form className='form' >
        ...
        <input name="duration" type="number" value={this.state.duration} onChange={this.onChangeForm} />
        <br />
        <label className="label">Description</label>
        <input name="description" type="text" value={this.state.description} onChange={this.onChangeForm} />
        <br />
        <input className="submit" type="submit" value="Book" onClick={this.onSubmit}/>
        <br />
      </form>
    )
  }
